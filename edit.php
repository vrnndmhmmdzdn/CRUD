...
<body class="bg-[#161B22]">
    ...
    <section class="shadow-md sm:rounded-lg p-10">
        <form class="max-w-md p-10 rounded-lg bg-gray-800 mx-auto flex flex-col" action="" method="post" enctype="multipart/form-data">
            <h1 class="text-3xl font-bold text-white">EDIT DATA</h1>
            ...
            <label for="image" class="text-lg font-normal mb-1 mt-3 text-white">Image</label>
            <div class="max-w-40 aspect-video overflow-hidden flex items-center mb-2">
                <img src="images/<?= $customer["image"]?>" class="object-cover w-full">
            </div>
            <input type="file" id="" name="old_image" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 hidden" value="<?= $customer["image"] ?>"/>
            <input type="file" id="image" name="image" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required/>
            
            <label for="barang" class="text-lg font-normal mb-1 mt-3 text-white">Barang/Sparepart</label>
            ...
            <button type="submit" name="submit" class="mt-5 text-white bg-[#238636] hover:opacity-90 focus:ring-4 focus:outline-none font-normal rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Submit</button>
        </form>
    </section>
</body>
</html>